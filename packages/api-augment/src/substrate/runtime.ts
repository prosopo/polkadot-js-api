...
import type { AnyNumber, IMethod } from '@polkadot/types-codec/types';
...
import type { AccountId, Balance, Block, Call, Header, Index, Slot, Weight, WeightV2 } from '@polkadot/types/interfaces/runtime';
